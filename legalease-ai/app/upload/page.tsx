...
export default function UploadPage() {
  ...
  const performAnalysis = async (fileData: UploadedFile) => {
    const fileId = fileData.id
    ...
    try {
      ...
      try {
        ...
        text = (await Promise.race([extractionPromise, timeoutPromise])) as string
        ...
        console.log("[v0] Analysis failed, using mock data for demonstration:", analysisError)
        analysis = analysisStorage.createMockAnalysis()
      }
      ...
      const stored = analysisStorage.storeAnalysis(analysisId, analysis, fileData.file.name)
